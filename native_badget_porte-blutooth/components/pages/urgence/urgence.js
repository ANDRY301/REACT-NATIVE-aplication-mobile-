...
useEffect( ()=>{
    axios.get(`http://localhost:3001/iot/liste_urgence/${stateAuth.matricule}`)
    .then( (response)=>{
  ...
  const DELETA = (jojo) => {
    axios.delete(`http://localhost:3001/iot/delete_urgence/${jojo}`).then((response) => {
                ...
                <View style={styles.conliste} key={item.id}>
                    <View >
                        <View style={styles.vtext}>
                            ...
                            <Text style={styles.text2}>: {item.nom}</Text>
                        </View>
                        <View style={styles.vtext} >
                                <Text style={styles.text}> Tel </Text>
                                <Text>       <FontAwesome5 name={'user'} solid size={12} style={styles.fontwa} /> </Text>
                                <Text style={styles.text3}>:  {item.tel}</Text>
                            </View>
                            
                            <View style={styles.vtext} >
                                <Text style={styles.text}> Mail </Text>
                                <Text>     <FontAwesome5 name={'user'} solid size={12} style={styles.fontwa} /> </Text>
                                <Text style={styles.text3}>:  {item.mail}</Text>
                            </View>
